...
int	draw_julia(int w, int h, int iter)
{
	double	z_x;
	double	z_y;
	double	c_re;
	...
	double julia_const_x = -0.1875;
	double julia_const_y = -1.0944;
...
void	draw_julia_init(t_data *img)
{
	int	w;
	int	h;
	int	iter;
